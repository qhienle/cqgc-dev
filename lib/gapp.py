...
class Configurator:
    ...
    def __init__(self, config_file=os.path.expanduser("~/.illumina/gapp_conf.json")):
        ...
        Example `gapp_conf.json` file:
        {
            ...
            "X-Auth-Token"     : "APIKey blah-blah-blah",
            ...
            "X-Gene42-Auth"    : "Basic blah-blah-blah=",
            "X-Gene42-Secret"  : "blah-blah-blah",
            "REDCap-Server"    : "https://tacc-redcap.bic.mni.mcgill.ca/api/",
            "REDCap-Token"     : "blah-blah-blah",
            "EMG-Username"     : "blah-blah-blah@ssss.gouv.qc.ca",
            "EMG-Password"     : "blah-blah-blah",
