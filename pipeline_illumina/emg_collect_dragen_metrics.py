...
"""
### DEPRECATED
### Collects metrics generated by DragenGermline run locally
### PRAGMatIQ now uses Dragen from Emedgene's Cloud pipeline, to collect those
### metrics use `emg_collect_samples_metrics.py` instead.
...
by DragenGermline (version 4+), which is expected to be found at:
/path/to/run/Analysis/1/Data/DragenGermline
